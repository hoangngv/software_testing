...
WebUI.setEncryptedText(findTestObject('Object Repository/Objects for Test Case 2/Page_ng nhp - Ti khon Google/input_Qu nhiu ln th khng thnh cng_password'), 
    'ZUi9IpFlWLqbrlDEkhAPvw==')
